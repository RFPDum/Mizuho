...
public class PricePersistenceServiceTest {
    ...
    public void should_only_retrieve_non_stale_prices_when_retrieveInstrumentPrices_is_called() {
        ...
        final InstrumentPrice price3             = ofInstrumentPrice(ISIN_2, VENDOR_1, DAY_MIN_1);
        final InstrumentPrice price4             = ofInstrumentPrice(ISIN_2, VENDOR_2, DAY_MIN_5);
        final InstrumentPrice price5             = ofInstrumentPrice(ISIN_1, VENDOR_1, DAY_MIN_10);
        final InstrumentPrice price6             = ofInstrumentPrice(ISIN_2, VENDOR_2, DAY_MIN_11);
